package com.gether.research.test.btrace;
...
public class HelloWorld {
  ...
  public static void returnMethod(@Self Object self, @ProbeClassName String probeClass,
      @ProbeMethodName String probeMethod, String password, @Return String result,
  ...
  public static void exceptionMethod(@ProbeClassName String probeClass,
      @ProbeMethodName String probeMethod, Exception e) {
  ...
  private static void initFiled() {
    if (null == rabbitmqFiled) {
      rabbitmqFiled = field(
          classForName("com.gether.research.mq.RabbitMqSender", contextClassLoader()),
          "rabbitTemplate");
    }
    if (null == aFiled) {
      aFiled = field(
          classForName("org.springframework.amqp.rabbit.core.RabbitTemplate", contextClassLoader()),
          "uuid");
    }
    if (null == bFiled) {
      bFiled = field(
