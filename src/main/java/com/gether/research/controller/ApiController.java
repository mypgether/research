...
public class ApiController {
  ...
  @RequestMapping("/name")
  @HystrixCommand(fallbackMethod = "getNameFallback", commandKey = "getNameKey", threadPoolKey = "getNameKey",
      commandProperties = {
